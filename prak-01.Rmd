...
3. Lade auch das "palmerpenguins" R package mit der Funktion `library()`
...
1. Führe den Code aus im Code-chunk mit dem Namen `penguins-vis-box` aus
...
1. Führe den Code aus
2. Erstelle einen Bar Plot mit der Funktion `geom_bar()` (**Tipp:** Gehe zurück zu Übung 3 und schau nach wie du einen Boxplot erstellt hast. Was könnte hier fehlen?)
3. Führe den Code aus
