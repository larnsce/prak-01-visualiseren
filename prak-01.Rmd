...
2. Ersetze den folgenden Scatterplot durch einen, der Boxplots zeichnet (**Tipp:** In der Symbolleiste der RStudio IDE gehe auf "Help -> Cheatsheets" und öffne das Cheatsheet für das "ggplot2" R Package)
3. Führe den Code aus
4. Ordne die Variable "species" dem Argument 'color' zu (**Tipp:** Schau was du im vorherigen Plot gemacht hast) 
5. Führe den Code aus
6. Ordne nun die Variable "island" dem Argument 'color' zu
